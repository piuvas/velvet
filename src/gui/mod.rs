...
use iced::{Alignment, Element, Length, Task, Theme, theme::Palette, window};
...
impl Velvet {
    ...
    pub fn update(&mut self, message: Message) -> Task<Message> {
        match message {
            ...
            Message::AddExtra(value) => self.extra_mods.push(value),
            Message::RemoveExtra(value) => _ = self.extra_mods.remove(value),
            Message::Pressed => {
                match &self.version {
                    Some(value) => {
